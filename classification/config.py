...
_C.MODEL = CN()
# Model name
_C.MODEL.NAME = 'groupmamba_tiny'
# could be overwritten by command line argument
_C.MODEL.PRETRAINED = ''
# Checkpoint to resume, could be overwritten by command line argument
_C.MODEL.RESUME = ''
# Checkpoint to evaluate, could be overwritten by command line argument
_C.MODEL.EVALUATE = ''
...
def update_config(config, args):
    ...
    if _check_args('evaluate'):
        config.MODEL.EVALUATE = args.evaluate
